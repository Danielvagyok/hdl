...
set_false_path -from [get_cells -hier -filter {name =~ *hdmi_raddr*           && IS_SEQUENTIAL}] -to [get_cells -hier -filter {name =~ *vdma_raddr_m1*   && IS_SEQUENTIAL}]
...
# set_false_path -from [get_cells -hier -filter {name =~ *vdma_waddr*          && IS_SEQUENTIAL}] -to [get_cells -hier -filter {name =~ *hdmi_waddr_m1*            && IS_SEQUENTIAL}]


create_clock -name ref_clk -period 6.7500 [get_ports reference_clk]
create_clock -name dma_clk -period 10.000 [get_ports vdma_clk]
