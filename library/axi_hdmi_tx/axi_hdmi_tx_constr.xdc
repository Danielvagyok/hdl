...
#set_property ASYNC_REG TRUE [get_cells -hier -filter {name =~ *vdma_raddr*}]
set_property ASYNC_REG TRUE [get_cells -hier -filter {name =~ *vdma_almost_full*}]
...
set_false_path -from [get_cells -hier -filter {name =~ *hdmi_raddr*           && IS_SEQUENTIAL}] -to [get_cells -hier -filter {name =~ *vdma_almost_full_m1*   && IS_SEQUENTIAL}]
set_false_path -from [get_cells -hier -filter {name =~ *hdmi_empty*           && IS_SEQUENTIAL}] -to [get_cells -hier -filter {name =~ *vdma_empty_m1*         && IS_SEQUENTIAL}]
